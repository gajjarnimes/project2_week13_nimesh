...
@Test
    ...
    sendTextToElement(By.xpath("//input[@id='FirstName']"), "Mehul");
    ...
    sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "Luton");
    sendTextToElement(By.cssSelector("#BillingNewAddress_Address1"), "34, Luton Road");
    sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"), "LU8 9HU");
    ...
    sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Mehul Shah");
